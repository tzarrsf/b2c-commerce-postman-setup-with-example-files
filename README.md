# Salesforce B2C Commerce Postman Setup for Partners

_Created by Tom Zarr with key contributions from Jorge Hernandez and Jonathan Tucker_

## Background and Use Case

This material is supplemental to the B2C Commerce implementation readiness curricula. Please consult the respective curriculum or course for obtaining an environment so you can set up, deploy and manage a Salesforce B2C Commerce environment.
...
#### Product Search - This section is a work in progress
